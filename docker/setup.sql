...
INSERT INTO task_template (`name`, `type`, `category`, `icon`, `task_yaml`, `schema`, `output`, `enable`, `create_time`, `update_time`) VALUES ('aliyun-ai-module', 1, 'function', '', 'resourceName: "aliyun_ai://xxx"\nresourceProtocal: "aliyun_ai"\nname: "aliyun_ai_template"\ncategory: "function"\npattern: "task_sync"', '{"type":"object","required":["appkey","model","prompt"],"properties":{"appkey":{"type":"string","title":"appkey"},"model":{"type":"string","title":"model"},"prompt":{"type":"string","title":"prompt"},"message_suffix":{"type":"string","title":"suffix message"},"message_prefix":{"type":"string","title":"prefix message"}}}', '', 1, now(), now());
