export default {
  ...
  exception: {
    ...
    subTitleDeveloping: 'Sorry,The page you are trying to access is under development.',
  ...
  login: {
    ...
    signInTitle: 'Cloud Native distributed, high-performance process orchestration engine.',
    signInDesc: '',
