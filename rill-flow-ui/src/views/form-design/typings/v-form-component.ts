...
// import { ComponentOptions } from 'vue/types/initGraphParams';
...
export interface IValidationRule {
  ...
  /**
   * built-in validation type, available initGraphParams: https://github.com/yiminghe/async-validator#type
   * @default 'string'
   * @type string
   */
  type?: string;
